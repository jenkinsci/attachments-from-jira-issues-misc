...
# Liquibase runner fails with an error message
#
# https://issues.jenkins.io/browse/JENKINS-71893

JENKINS_WAR_VERSION=2.332.2
...
JENKINS_HOME=. /opt/jdk-8/bin/java -jar ../$JENKINS_WAR
