...
public class NUnitArchiver implements FilePath.FileCallable<Boolean>, Serializable {
    ...
    /**
     * Strips out UTF8 BOM character fropm start of XML string if present
	 * ref: http://www.rgagnon.com/javadetails/java-handle-utf8-file-with-bom.html
     * 
     * @param parentPath parent
     * @return an array of strings
     */
    private String String removeUTF8BOM(String originalXML) {

        if (originalXML.startsWith(UTF8_BOM)) {
