...
# File with umlaut characters not copied by copyartifact plugin
#
# https://issues.jenkins.io/browse/JENKINS-71351
...
LANG=it_IT.UTF-8 JENKINS_HOME=. java -jar ../$JENKINS_WAR
