...
# User reports that built on column does not honor the prefix setting
#
# https://issues.jenkins.io/browse//JENKINS-46773


JENKINS_WAR_VERSION=2.393
...
JENKINS_HOME=. java -jar ../$JENKINS_WAR --prefix=/jenkins
